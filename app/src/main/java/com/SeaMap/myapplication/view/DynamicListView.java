...
public class DynamicListView extends ListView {
    ...
    /*
    itemID Luu tru mot tham chieu den cac item tren va duoi.
    itemID phia tren hoac duoi co the khong hop le.
     */
    ...
    /*
    Phuong thuc nay xac dinh khi di chuyen item du xa de hoan doi o va xac dinh du lieu dc thay doi.
    Khi thong bao thay doi vi tri. Su dung ViewTreeObserver và tương ứng OnPreDrawListener  de hoan doi
     */
    ...
    //Dat ve trang thai trc do ( item tro ve vi tri ban dau);
    ...
    //Khi khong muon di chuyen o da chon -> Tro ve trang thai ban dau trc do
    ...
    /*
    TypeEvaluator này được sử dụng để làm động BitmapDrawable trở lại vị trí cuối cùng của nó
    trc khi nhấc ngón tay lên bằng cách sửa đổi giới hạn của BitmapDrawable.
    Đồng thời tạo một phương thức handleMobileCellScroll để xác định xem listview có ở trạng thái cuộn hay không.
    */
    ...
    /*
    xác định nếu ô di chuột ở trên hoặc dưới giới hạn của listview.
    listview thực hiện một cuộn trơn tru lên hoặc xuống thích hợp để hiển thị các mục mới
    */
    ...
    /*
    Xd cuon này được thêm vào listview để xử lý hoán đổi ô khi ô nằm ở cạnh trên cùng hoặc dưới cùng của listview.
    Nếu ô di chuột ở một trong hai cạnh của listview, listview bắt đầu cuộn.

   listview liên tục kiểm tra khả năng hiển thị của các ô mới và cũng xác định xem chúng có phu hop cho việc hoán đổi ô hay không.
     */
